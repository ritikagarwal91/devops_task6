...
scm {
github ('ritikagarwal91/devops-task6-try','master')
}
...
if sudo ls /devopstask3 | grep html
then
...
sudo kubectl cp /devopstask3/*.html   $htmlpod:/usr/local/apache2/htdocs ''')
}
 triggers {
...
description ("my fifth kube job")
 ...
 publishers {
        mailer('agarwalritik91@gmail.com', true, true)
    }
triggers {
